  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const res = await axios.get(`ttps://react-ecommerce-main.onrender.com/api/admin/products?${params.toString()}`, {
              ...
              {sortedProducts.length > 0 ? (
                sortedProducts.map((product) => (
                  <tr key={product._id} className={product.stock <= 5 ? 'low-stock' : ''}>
                    ...
                    <td>
                      <img
                        src={product.image || 'ttps://react-ecommerce-main.onrender.com/uploads/default-image.png'}
                        alt={product.name}
                        width="50"
                        onError={(e) => {
                          console.log('Dashboard image load failed:', e.target.src);
                          e.target.src = 'ttps://react-ecommerce-main.onrender.com/uploads/default-image.png';
                        }}
                      />
                    </td>
                  </tr>
