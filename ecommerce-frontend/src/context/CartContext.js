...
export function CartProvider({ children }) {
  ...
  const fetchCart = async () => {
    try {
      ...
      const res = await axios.get('https://react-ecommerce-main.onrender.com/api/cart', {
      ...
      const processedCartItems = cartItems.map(item => ({
        ...
        productId: {
          ...
          image: item.productId?.image && typeof item.productId.image === 'string'
            ? `https://react-ecommerce-main.onrender.com${item.productId.image}`
      ...
      if (isBulk) {
        ...
        for (const item of items) {
          res = await axios.post(
            'https://react-ecommerce-main.onrender.com/api/cart/add',
        ...
        res = await axios.post('https://react-ecommerce-main.onrender.com/api/cart/add', payload, {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const removeFromCart = async (itemId) => {
    try {
      ...
      const res = await axios.delete(`https://react-ecommerce-main.onrender.com/api/cart/${itemId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const updateQuantity = async (itemId, quantity) => {
    try {
      ...
      const res = await axios.put(
        `https://react-ecommerce-main.onrender.com/api/cart/${itemId}`,
        { quantity },
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const clearCart = async () => {
    try {
      ...
      const res = await axios.delete('https://react-ecommerce-main.onrender.com/api/cart', {
        headers: { Authorization: `Bearer ${token}` },
      });
